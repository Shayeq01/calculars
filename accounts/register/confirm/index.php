                ...
                <div class="standard_padding flexbox complete_width" style="margin-top: 10px;">
                    <div class="full_height margin_vertical_auto right_form" style="width: 50%" id="side_logo">
                        <div class="margin_auto">
                            ...
                            <div class="">Revoultionize your competitive exams' practice.</div>
                        </div>
                    </div>
                    <div class="flexbox margin_vertical_auto" style="width: 50%">
                        <div class="flexbox complete_width">
                            <form action="" class="flexbox complete_width" method="post">
                                <div class="flexbox flex_different complete_width">
                                    ...
                                    <div class="complete_width">
                                        <div class="align_center font_heavy" style="font-size: 24px">Confirm your email address</div>

                                    </div>
                                    <div class="input_distance complete_width element_distance">
                                        <label for="" class="">Enter verification code sent to registered email address</label>
                                        <input type="num" name="code" placeholder="Enter verification code"
                                    ...
                                    <div class="input_distance complete_width element_distance">
                                        <input type="submit" value="Validate my Account"
