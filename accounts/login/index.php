        ...
        <div class="bg text roboto complete_height flexbox flex_different" id="regular">
            ...
            <div class="standard_padding min_height_complete">
                ...
                <div class="standard_padding flexbox complete_width" style="margin-top: 10px;">
                    ...
                    <div class="flexbox right_form" style="width: 50%">
                            ...
                            <form action="" class="flexbox complete_width" method="post">
                                <div class="flexbox flex_different complete_width">
                                    ...
                                    <div class="complete_width">
                                        <div class="align_center font_heavy" style="font-size: 24px">Login</div>
                                    ...
                                    <div class="complete_width">
                                        <div class="align_center">Forgot your Password? <a href="http://localhost/accounts/forgot/">Recover it Now!</a></div>
                                        <div class="align_center standard_margin_top">New a new Account? <a href="http://localhost/accounts/register">Register for Free!</a></div>
                                    </div>
                                </div>
                            </form>
                        </div>
